...
> = {
  admin: {
    fr: 'Admin',
    ht: 'Admin',
    cls: 'bg-primary/10 dark:bg-primary/20 text-primary border-primary/30',
    Icon: ShieldCheck,
  },
  reviewer: {
    fr: 'Réviseur',
  ...
  if (!isEditor || !isAdmin) {
    return (
      <div className="container py-12">
        <div className="rounded-xl border border-amber-200 dark:border-amber-500/30 bg-amber-50 dark:bg-amber-500/10 p-6 max-w-2xl">
      ...
      <div className="mx-auto w-full max-w-[1400px] px-4 sm:px-6 lg:px-10 py-10 lg:py-12 space-y-6">
        ...
        {inviting && (
          <form
            ...
            className="animate-in fade-in slide-in-from-top-2 duration-300 rounded-xl border border-amber-300 dark:border-amber-500/30 bg-amber-50/40 dark:bg-amber-500/10 p-5 space-y-3"
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              <label className="flex flex-col gap-1">
                ...
                <input
                  ...
                  className="w-full h-10 px-3 rounded-md border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900 text-sm text-slate-900 dark:text-slate-100 outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary"
                />
              </label>
              <label className="flex flex-col gap-1">
                <span className="text-[10px] font-bold uppercase tracking-widest text-primary/70">
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400 flex items-start gap-2">
              <Mail className="w-3.5 h-3.5 mt-0.5 text-slate-400 dark:text-slate-500 flex-shrink-0" />
              {isFr
            ...
            <div className="flex items-center justify-end gap-2">
              <button
                ...
                disabled={busy}
                className="inline-flex items-center gap-1.5 rounded-md border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900 px-3 py-1.5 text-xs font-semibold text-slate-700 dark:text-slate-200 hover:border-slate-400 dark:hover:border-slate-600 disabled:opacity-50"
              >
        ...
        {filtered === null ? (
          ...
          <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 overflow-hidden">
            <table className="w-full text-sm">
              <thead className="bg-slate-50/60 dark:bg-slate-800/60 text-left text-[10px] font-bold uppercase tracking-widest text-slate-500 dark:text-slate-400">
                <tr>
                    ...
                    <tr key={u.id} className="hover:bg-slate-50/50 dark:hover:bg-slate-800/40 transition-colors">
                      <td className="px-4 py-3">
                        <div className="flex flex-col">
                          ...
                          {!u.email_verified && (
                            <span className="mt-1 inline-flex items-center gap-1 text-[10px] font-bold uppercase tracking-wider text-amber-700 dark:text-amber-400">
                      ...
                      <td className="px-4 py-3 text-right">
                        <button
                          ...
                          className="inline-flex items-center gap-1 text-xs font-semibold text-red-700 dark:text-red-400 hover:text-red-800 dark:hover:text-red-300 hover:bg-red-50 dark:hover:bg-red-500/10 px-2 py-1 rounded-md transition-colors"
