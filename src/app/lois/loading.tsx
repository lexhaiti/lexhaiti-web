      ...
      <div className="border-b border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/50">
        <div className="mx-auto w-full max-w-[1400px] px-4 sm:px-6 lg:px-10 py-4">
          <div className="flex items-center gap-3 flex-wrap">
            ...
            <div className="h-10 w-32 bg-slate-100 dark:bg-slate-800/60 rounded-lg animate-pulse" />
            <div className="h-10 w-32 bg-slate-100 dark:bg-slate-800/60 rounded-lg animate-pulse" />
          </div>
        </div>
      </div>
      ...
      <div className="mx-auto w-full max-w-[1400px] px-4 sm:px-6 lg:px-10 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
          {Array.from({ length: 9 }).map((_, i) => (
            ...
            >
              <div className="h-4 w-20 bg-slate-100 dark:bg-slate-800/60 rounded animate-pulse" />
