        ...
        return (
          <li key={entry.id}>
            {enabled ? (
                ...
                <span className="flex items-center gap-2 min-w-0">
                  <span
                    ...
                    className={cn(
                      ...
                      isActive ? 'bg-primary' : 'bg-slate-300 group-hover:bg-slate-400',
                    )}
                  />
              ...
              <span className="flex items-center gap-2 rounded-lg px-3 py-2 text-sm text-slate-300 cursor-not-allowed">
                <span aria-hidden className="h-1.5 w-1.5 rounded-full bg-slate-200" />
                <span className="truncate">{t(entry.labelKey)}</span>
              </span>
            )}
          </li>
    ...
    <>
      ...
      >
        <nav className="sticky top-28">
          <p className="mb-3 flex items-center gap-2 px-3 text-[10px] font-bold uppercase tracking-widest text-slate-400">
